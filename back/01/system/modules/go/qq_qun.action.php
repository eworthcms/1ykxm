...
class qq_qun extends SystemAction {
	...
	public function get_cityqq(){
		 ...
		 $prov=trim($this->segment(4));	  
		 $cityv=trim($this->segment(5));	
		 $couv=trim($this->segment(6));
		 ...
		 if(!empty($res)){
			 $str='<ul>';		 
			 foreach($res as $v){		
				$str.='<li><dt><img border="0" alt="'.$v['name'].'" src="'.G_TEMPLATES_IMAGE.'/qqwm.jpg"></dt><dt>'.$v['name'];
				if($v['full']=='已满'){

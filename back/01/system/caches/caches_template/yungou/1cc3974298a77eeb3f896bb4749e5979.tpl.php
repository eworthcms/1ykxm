...
<div class="content clearfix">
	...
	<div id="divInfo0" class="New-content">
		...
		<div class="scroll-list">
			<div class="R-tit">
				...
				<i>在<?php echo microt($go['time'],"r"); ?>开心购了</i>
			...
			<div class="buy-com">
				...
				<div class="buy-rcon">
					...
					<p class="buy-code gray02">幸运开心购码：<span class="orange"><?php echo $jiexiao['q_user_code']; ?></span></p>
	...
	<?php  else: ?>
	<div class="New-content"><div class="tips-con"><i></i>TA还没有开心购商品哦</div></div>
	<?php endif; ?>   
</div>

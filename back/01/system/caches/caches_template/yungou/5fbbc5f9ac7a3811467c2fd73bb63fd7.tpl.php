		...
		<div id="divResult" class="wait_list hidden" style="display: block;">
			...
			<dl>
				...
				<dd><h2 class="orange Fb">恭喜您，支付成功！请等待系统为您揭晓！</h2>
					<p>您现在可以<a href="<?php echo WEB_PATH; ?>/member/home/userbuylist" class="blue">查看开心购记录</a>或<a href="<?php echo WEB_PATH; ?>" class="blue">继续购物</a></p>
					<!-- <p>总共成功开心购1件商品，信息如下：</p> -->
				</dd>
			</dl>
			</div>
			<!--
			...
			<ul>
				<li class="wait_Ltit">
					...
					<span class="wait_Cw03">开心购人次</span>
					<span class="wait_Cw04">开心购编码</span>
				</li>

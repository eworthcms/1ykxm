...
<div class="R-content">
	...
	<div class="email_verification">
		<div class="prompt orange">请完成邮箱验证，认证邮箱不仅能加强账户安全，快速找回密码，还会在您成功开心购到商品后及时通知您！<em></em></div>
		...
		<div  class="text_email" style="padding-top:0px"><div class="Validform_checktip">点击“发送验证邮件”1元开心购系统将会给您发送一封验证邮件到您的邮箱！</div></div>
		</form>
	</div>
</div>

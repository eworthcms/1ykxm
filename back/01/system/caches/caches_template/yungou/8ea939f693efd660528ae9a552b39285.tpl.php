...
<div class="R-content">
	<div class="member-t"><h2>开心购记录</h2></div>
	<?php 
	...
	<div class="yg_record_goods">
		...
		<div class="yg_record_r">
			...
			<li class="gray02">本期商品开心购已结束 【获得者：<a href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($record['uid']); ?>" target="_blank" class="blue">
	...
	<div class="goods-tit gray02">
		<p class="fl">本期商品您总共开心购<span><?php echo $record['gonumber']; ?></span>人次 拥有<span><?php echo $record['gonumber']; ?></span>个开心购码</p><a href="<?php echo WEB_PATH; ?>/member/home/userbuylist" class="blue fr">&lt;&lt; 返回列表</a>
	</div> 

	<div class="list-tab goodsList" id="userbuylist">
		<ul class="listTitle">
			<li class="leftTitle">开心购时间</li>
			<li>开心购人次</li>
			<li class="Code">开心购码</li></ul>

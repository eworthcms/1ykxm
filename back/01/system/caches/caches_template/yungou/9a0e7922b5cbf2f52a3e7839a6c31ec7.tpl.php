    ...
    <section class="goodsCon pCon">
        ...
        <div class="pProcess pProcess2">
    	    <div class="pResults">
        	    ...
        	    <div class="pResultsR">
                    <div class="g-snav">
                        <div class="g-snav-lst">总共开心购<br><dd><b class="orange"><?php echo $gorecode['gonumber']; ?></b><br>人次</dd></div>
                        <div class="g-snav-lst">揭晓时间<br><dd class="gray9"><span><?php echo microt($item['q_end_time']); ?></span></dd></div>
                        <div class="g-snav-lst">开心购时间<br><dd class="gray9"><span><?php echo microt($gorecode['time']); ?></span></dd></div>
                    </div>
                </div>
        	    <p><a href="<?php echo WEB_PATH; ?>/mobile/mobile/calResult/<?php echo $item['id']; ?>" class="fr">查看计算结果</a>幸运开心购码：<b class="orange"><?php echo $item['q_user_code']; ?></b></p>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="pDetails <?php if($item['q_end_time']!=''): ?>pDetails-end<?php endif; ?>">
		    ...
		    <?php  else: ?>
              ...
              <div id="btnBuyBox" class="pBtn" codeid="<?php echo $item['id']; ?>">
				<a href="javascript:;" class="fl buyBtn">立即1元开心购</a>
        ...
        <div class="joinAndGet">
    	    <dl>
    	        <a href="<?php echo WEB_PATH; ?>/mobile/mobile/buyrecords/<?php echo $item['id']; ?>"><b class="fr z-arrow"></b>所有开心购记录</a>
			...
			<ul id="prevPeriod" class="m-round" codeid="<?php echo $gorecode['shopid']; ?>" uweb="<?php echo $gorecode['uid']; ?>">
                ...
                <li class="getInfo">
                    ...
                    <dd>总共开心购：<em class="orange arial"><?php echo $gorecode['gonumber']; ?></em>人次</dd>
                    <dd>幸运开心购码：<em class="orange arial"><?php echo $gorecode['huode']; ?></em></dd>
                    <dd>揭晓时间：<?php echo microt($itemlist[0]['q_end_time']); ?></dd>								   
                    <dd>开心购时间：<?php echo microt($gorecode['time']); ?></dd>
                </li>
            </ul>
			<?php endif; ?>

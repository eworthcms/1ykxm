...
<div class="show_content">
	...
	<div class="Pro_Details">
		...
		<div class="Pro_Detright">
				...
				<div class="Announced_FrameGet">
					<dl>
						<dd class="gray02">
							...
							<p>开心购时间：<?php echo microt($user_shop_time); ?></p>
						</dd>
					</dl>
				</div>
			...
			<div class="MaCenter">
				<p>商品获得者本期总共开心购了<em class="orange"><?php echo $user_shop_number; ?></em>人次</p>
	...
	<div id="divCalResult" class="Product_Content">
		<div class="ygRecord hide" style="">
            <div class="yghelp">
                ...
                <br>
                3、将这100个数值之和除以该商品总参与人次后取余数，余数加上10000001 即为“幸运开心购码”。
                <?php if(!$item['q_content']): ?>
                <br>
                <b>由于网站还未满100条购买记录。所以按照   10000001 + (揭晓时间求和结果*100/参与人数) 的余数   即为“幸运开心购码”。</b>
                <?php endif; ?>
            </div>
			...
			<div class="FloatBox"></div>	
			   ...
			   <ul class="Record_content">
                ...
                <div class="RecordOnehundred"><h4> 100条计算结果 </h4>
           		 <div class="ResultBox"><h2>计算结果</h2>
					<p class="num4">求和：
						<span class="Fb"><?php echo $item['q_counttime']; ?></span>(上面100条开心购记录时间取值相加之和)<br>取余：
		...
		<div class="AllRecW AllReclist">
			...
			<div class="AllRecR fl ">
                <p class="AllRecR_T">
                    <span name="spCodeInfo" class="AllRecR_Over" isload="0" isshow="0" buyid="8888" style="cursor: pointer;" >
                        ...
                        <?php endif; ?>
                        开心购了<em class="Fb orange"><?php echo $user['gonumber']; ?></em>人次
                        <a name="btnShow" style="display: none;" class="AllRecR_See" href="javascript:void()">查看云购码<s></s></a>
                    </span>
                </p>
                <p class="AllRecR_Code gray02" style="display: none;">
                    <?php echo reyugoucode($user['goucode']); ?>
                </p>
                <a class="AllRecR_close" href="javascript:void();" title="收起"></a>
			</div>
		</div>
		<?php  endforeach; $ln++; unset($ln); ?>
...
<script>
    $(".AllRecR_Over").hover(function(){
                $(this).children(".AllRecR_See").fadeIn();
    },function(){
                $(this).children(".AllRecR_See").fadeOut();
            }
    );
    $(".AllRecR_Over").click(function(){
        $(this).parent().parent().addClass("AllRecRCur");
        $(this).parent().next("p").show(1000);
    });
    $(".AllRecR_close").click(function(){
        $(this).parent().removeClass("AllRecRCur");
        $(this).prev("p").hide(500);
    });
$(function(){
...
var height=$("#userRnoId").css("height");
	if(height=="90px"){
        ...
        $(".MaOff > span").html('收起<s></s>');
        $(".MaOff > span > s").css({backgroundPosition:"-273px -13px"});

	}else{
		$("#userRnoId").css("height",90);
        $(".MaOff > span").html('展开查看全部<s></s>');
        $(".MaOff > span > s").css({backgroundPosition:"-262px -13px"});
	};
}
$(function(){

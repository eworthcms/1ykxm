		...
		?>
			...
			?>
   			...
   			<dl class="ft-weixin">
   				...
   				<dd class="gray02">关注1元开心购免费抽大奖</dd>
   			</dl>
   		</div>
   	</div>
...
<div class="footer" style="height:auto;">
	...
	<div class="footer_icon" style="width:599px;">
		<ul>
			...
			<li class="fi_315online"><a target="_blank" href="http://www.yungoucms.com/get.php?url=<?php echo G_WEB_PATH;?>"><span>开心购商业授权值得信赖</span></a></li>

...
return array (
  ...
  'routes' => array(		
			...
			//diy url
			'a_list' => 'go/index/glist',//所有商品
            'a_list/(:any)' => 'go/index/glist/$1',
			'sai' => 'go/shaidan',//晒单
			'last_lottery' => 'go/index/lottery',//最新揭晓
            'new_register/(:any)' => 'member/user/new_register/$1',
            'new_register' => 'member/user/new_register',
  )
);
?>
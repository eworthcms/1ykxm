...
<!-- 内页顶部 -->
        ...
        <section class="clearfix g-share-lucky">        
			...
			<div class="u-lucky-r">
				...
				<p>幸运开心购码：<em class="orange"><?php echo $jikxiao['q_user_code']; ?></em></p>
				<?php endif; ?>
				<p>本期开心购：<em class="orange"><?php echo get_user_goods_num($shaidan['sd_userid'],$shaidan['sd_shopid']); ?></em>人次</p>

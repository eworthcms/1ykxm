...
<div class="Newpublish">
				...
				<ul id="ProductList">
					...
					<li class="Cursor">
						...
						<div class="publishC-Member gray02"><a class="fl headimg" href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($qishu['q_uid']); ?>" target="_blank" >
							...
							<p>开心购：<em class="orange Fb"><?php echo get_user_goods_num($qishu['q_uid'],$qishu['id']); ?></em>人次</p>
						</div>
						...
						<div class="details">
							<p class="fl details-Code">幸运开心购码：<em class="orange Fb"><?php echo $qishu['q_user_code']; ?></em></p>
	...
	<div class="NewpublishR">
		<div class="Newpublishbor">
			<div class="Rtitle gray01">TA们正在开心购 </div>
			<div class="Rcenter buylistH">
				<ul id="buyList" style="margin-top: 0px;">
					...
					<li><a href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($record['uid']); ?>" target="_blank" class="pic">						
						...
						<p class="Rtagou"><a class="blue" href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($record['uid']); ?>" target="_blank"><?php echo userid($record['uid'],'username'); ?></a>刚刚开心购了</p>

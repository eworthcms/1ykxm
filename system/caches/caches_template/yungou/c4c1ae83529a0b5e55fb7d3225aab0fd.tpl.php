...
<div class="goods_hot">
		...
		<div class="hot" style="">
			...
			<ul id="hostGoodsItems" class="hot-list">											
				...
				<li class="list-block">
					...
					<div class="shop_buttom"><a href="<?php echo WEB_PATH; ?>/goods/<?php echo $renqi['id']; ?>" target="_blank" class="shop_but" title="立即开心购"></a></div>
				</li>
				<?php  endforeach; $ln++; unset($ln); ?>
			</ul>
		</div>
	...
	<div class="goods_right">
		...
		<a href="<?php echo G_WEB_PATH; ?>/goods/16914" target="_blank"><img src="<?php echo G_TEMPLATES_STYLE; ?>/handwork/kslg-v3.jpg" width="230" height="200"></a>
		</div>
			...
			<div class="buyList">		
                <ul id="buyList" style="margin-top: 0px;">
					...
					<li>
						...
						<span class="who"><p style="display: inline;"><a class="blue" href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($gorecord['uid']); ?>"><?php echo get_user_name($gorecord); ?></a></p>刚刚开心购了</span>
...
<div class="get_ready">
	...
	<ul id="readyLotteryItems" class="hot-list">
		...
		<li class="list-block">
			...
			<div class="shop_buttom"><a href="<?php echo WEB_PATH; ?>/goods/<?php echo $shop['id']; ?>" target="_blank" class="shop_but" title="立即开心购"></a></div>
		</li>
		<?php  endforeach; $ln++; unset($ln); ?>			
	</ul>
</div>

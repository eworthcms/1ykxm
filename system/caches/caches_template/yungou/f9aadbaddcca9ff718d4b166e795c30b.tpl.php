...
<div class="header">
    <div class="site_top">
        <div class="head_top">
            ...
            <p class="push-zone">
                <iframe src="http://open.qzone.qq.com/like?url=http%3A%2F%2Fuser.qzone.qq.com%2F44352&type=button_num&width=80&height=30&style=1" allowtransparency="true" scrolling="no" border="0" frameborder="0" style="width:80px;height:30px;border:none;overflow:hidden;"></iframe>
            </p>
                ...
                <li class="h_1yyg">
                    ...
                    <div class="h_1yyg_eject" style="display:none;">
                        <dl>
                            ...
                            <dd><a  href="<?php echo WEB_PATH; ?>/member/home/userbuylist">开心购记录</a></dd>
    ...
    <div class="head_mid">
        <div class="head_mid_bg">
            ...
            <div class="head_search">
                <input type="text" id="txtSearch" class="init" value='输入"苹果"试一试， 惊喜就在开心购' />
...
//		$("#txtSearch").css({background:"#FFFFCC"});
        ...
        $("#txtSearch").blur(function(){
            ...
            if(va2==""){
                $("#txtSearch").val('输入"苹果"试一试， 惊喜就在开心购');
            }
        });

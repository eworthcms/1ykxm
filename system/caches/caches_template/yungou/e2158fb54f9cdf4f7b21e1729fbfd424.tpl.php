    ...
    <div class="left">
        ...
        <div class="reg_box ">
            ...
            <div class="item msg_zt1">
                <label>手机号码：</label>
                <input type="text" class="itext1" id="mobil" datatype="m" sucmsg="帐号验证通过" nullmsg="请输入正确的手机号码" errormsg="手机号码格式不正确">
            ...
            <div class="item i_code msg_zt1">
                ...
                <!--<div class="msg_box row1"><span class="msg">请输入验证码</span></div>-->

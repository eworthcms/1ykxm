...
<div class="help-main">
	<div class="qqGroup">
		<div class="qqTitle">
			<span class="groupt">开心购<b>QQ</b>群</span>
			<span>为打造更具公平、透明的开心购平台，2元开心购特成立各地QQ交流群（可在选择框查找本地群），欢迎广大云友加入。<br>另外，2元开心购正在招募各地群主加盟，也可自建群，具体待遇和要求请咨询QQ:717597650</span>
		</div>
		...
		<div class="qsearch">			
			<ul>
				...
				<script src="<?php echo G_TEMPLATES_JS; ?>/area_city.js" type="text/javascript"></script>

	...
	<div class="W-left fl">
			...
			<ul class="process">
				<li class="p-1">
					<div class="process_con S01 hidden">
						<span><em>◆</em><s>◆</s></span>
						您每邀请一位好友成功参与开心购即可获得50福分。
					</div>
				</li>
				<li class="p-2">
					<div class="process_con S02 hidden">
						<span><em>◆</em><s>◆</s></span>
						经您邀请的所有好友，成功参与开心购后，您都可以获得6%的现金奖赏，并且永久有效。
					</div>				    
				</li>
				<li class="p-3">
					<div class="process_con S03 hidden">
						<span><em>◆</em><s>◆</s></span>
						您每邀请一位好友成功参与开心购，就可获得一个超级礼包抽奖机会；邀请越多，获奖机率就越大，快快告诉你QQ、MSN、人人、开心、微博上的朋友吧；具体活动详情请关注开心购圈中活动专区。
					</div>				    
				</li>
				<li class="p-4">
					<div class="process_con S04 hidden">
						<span><em>◆</em><s>◆</s></span>
						每月成功邀请好友数量最多的前10000名云友，都可获得（<a href="<?php echo G_WEB_PATH; ?>"><?php echo G_WEB_PATH; ?></a>） “宝马3系”“开心购码”一个，若邀请好友数量相同，则以邀请时间先后顺序为准。把宝马开回家的可能就是您哦！
					</div>
				</li>
			</ul>
		</div>
		...
		<?php  else: ?>	
		    ...
		    <div class="Invitation-C1">
			    ...
			    <div class="">
			    <textarea disabled="disabled" name="copyShareText" id="fe_text" class="textarea">我刚发现一个很好很好玩的网站，1元就能买iPhone 5S哦，快去看看吧！
<?php echo WEB_PATH; ?>/register/<?php echo $uid; ?></textarea>
	...
	<div class="W-right fr">
		...
		<div class="rig_con">
			<ul>
				<li><h5>1、在哪里可以看到我的佣金？</h5><p>在【我的个人中心】的【佣金明细】里可看到您的每次返现记录。佣金满100及以上可申请提现，任何时候都可充值到开心购帐户参与开心购。</p></li>
